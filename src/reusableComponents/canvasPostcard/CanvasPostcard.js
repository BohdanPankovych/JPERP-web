        ...
        <Stage width={width} height={height} ref={reference}>
            <Layer>
                ...
                {selectedEvents.length < 2 ? (
                    ...
                    <>
                        <CanvasEventItem x={70} y={90} img={selectedEvents[0].img}
                                         text={selectedEvents[0].description}/>
                        <CanvasEventItem x={70} y={360} img={selectedEvents[1].img}
                                         text={selectedEvents[1]?.description}/>
                    </>
                    ...
                    <>
                        ...
                        <CanvasEventItem x={70} y={360} img={selectedEvents[1].img}
                                         text={selectedEvents[1]?.description}/>
                        <CanvasEventItem x={290} y={90} img={selectedEvents[2].img}
                                         text={selectedEvents[2]?.description}/>
                    </>
                    ...
                    <>
                        ...
                        <CanvasEventItem x={290} y={90} img={selectedEvents[2].img}
                                         text={selectedEvents[2]?.description}/>
                        <CanvasEventItem x={290} y={360} img={selectedEvents[3].img}
                                         text={selectedEvents[3]?.description}/>
                    </>
                ) : (null)}
                {/*<CanvasEventItem x={70} y={90} img={selectedEvents[0].img} text={selectedEvents[0].description} />*/}
